...
def find_probability(coin, expiration_time, strike):
    ...
    dstrike = price / 10000
    predicted_probability = ((Interpolation(strike - dstrike / 2) - Interpolation(strike + dstrike / 2)) / dstrike) * np.exp(time_to_expiration * discount_rate)
...
if __name__ == "__main__":
    ...
    expiration_time = datetime(2023, 9, 26, 2)  # Example expiration time 2 am
    strikes = [26000, 26500, 27000, 27500, 28000,28500]  # Example strike
    probs = []
    for s in strikes:
